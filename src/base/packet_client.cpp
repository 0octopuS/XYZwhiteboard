...
void WhiteboardPacket::new_modify_element_request(
    uint32_t user_id, std::string whiteboard_id,
    WhiteboardElements _orig_element, WhiteboardElements _modi_element) {
#ifndef NDEBUG
  printf("--- WhiteboardPacket::new_modify_element_request()\n");
#endif
  protobuf::PacketAction action;
  protobuf::ModifyElementRequest *modi_element_request =
      action.mutable_modifyelement();
  modi_element_request->set_user_id(user_id);
  modi_element_request->set_whiteboard_id(whiteboard_id);
  // WhiteboardElements element;
  auto orig_proto_element = _orig_element.to_protobuf();
  auto modi_proto_element = _modi_element.to_protobuf();
  // WhiteboardElementsType _ele_type = _element.get_type();
  auto orig_proto_element_field = modi_element_request->mutable_orig_element();
  auto modi_proto_element_field = modi_element_request->mutable_modi_element();
  std::swap(orig_proto_element, *orig_proto_element_field);
  std::swap(modi_proto_element, *modi_proto_element_field);
  // add_element_request->set_allocated_element(&proto_element);
  // type = WhiteboardPacketType::addElement;
  // addElementRequest = request;
  new_packet(action);
...
void WhiteboardPacket::new_delete_element_request(uint32_t user_id,
                                                  std::string whiteboard_id,
                                                  WhiteboardElements _element) {
#ifndef NDEBUG
  printf("--- WhiteboardPacket::new_add_element_request()\n");
#endif
  protobuf::PacketAction action;
  protobuf::DeleteElementRequest *delete_element_request =
      action.mutable_deleteelement();
  delete_element_request->set_user_id(user_id);
  delete_element_request->set_whiteboard_id(whiteboard_id);
  // WhiteboardElements element;
  auto proto_element = _element.to_protobuf();
  // WhiteboardElementsType _ele_type = _element.get_type();
  auto proto_element_field = delete_element_request->mutable_orig_element();
  std::swap(proto_element, *proto_element_field);
  // add_element_request->set_allocated_element(&proto_element);
  // type = WhiteboardPacketType::addElement;
  // addElementRequest = request;
